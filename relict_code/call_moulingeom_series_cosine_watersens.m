...
parameters.unfilled_melting    = [1 1 1 1 1 1 ...
                                  1 3 ...
                                  1 1 1 1 1]  ;                                         %what type of melting do you want above the water line? 
...
parameters.f_sub               = [0.05 0.05 0.05 0.05 0.05 0.05 ...
                                  0.05 0.05 ...
                                  0.01 0.03 0.05 0.1 0.5];                                      % friction factor for the subglacial system - it should be ~ between 0.03 and 0.2, the water level in the moulin is very sensitive to this.
                                                
parameters.Tdatatype           = {'Ryser_foxx'};
...
parameters.relative_roughness_OC = 0.2;                                    %relative roughness above the water line for open channel

parameters.fR_wet                = [0.01 0.1 0.5 1 3 5 ...
                                    1 1 ...
                                    1 1 1 1 1];                                     % This is used when in moulingeom_fcn, fR_fixed is true (right now it is on 4/7/20 LCA)
...
for ii = 1:maxlengthofseries
   ...
   copyfile([workingdirectory, '/call_moulingeom_series_cosine_watersens.m'], [savelocation, '/', savefile, '_call_moulingeom_series_cosine_water_sens.m']);
