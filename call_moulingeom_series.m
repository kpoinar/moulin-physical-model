...
if ~exist(['./modeloutputs/', savefile], 'dir')
    ...
    mkdir(['~/Documents/Repositories/Moulin/operational/moulin-physical-model/modeloutputs/', savefile]) 
end    
...
%savelocation        =['./modeloutputs/', savefile];
savelocation         = ['~/Documents/Repositories/Moulin/operational/moulin-physical-model/modeloutputs/', savefile]; % where do you want to save the outputs?
workingdirectory    = pwd; %yeah, I know this is a pain, but it makes things work more easily


parameters.numofdays           =  20;              %for how many days do you want to run the model?
...
parameters.use_pD_downstream   = true; 
parameters.fract_pd_melting    = 0.005;            %This isnt subglacial friction factor, fraction of energy from potential drop that is used for melting
...
parameters.fR_fixed_wet                = 0.1;  
parameters.fR_fixed_oc                 = 10; 
